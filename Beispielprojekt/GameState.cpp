	...
	, TestSound("Windows Critical Stop.wav")
{
	...
	KeyR21 = erstelle_Objekt_fest_ptr(58, 437, -1000, -300, 100, WandR2L1, std::make_shared<Gosu::Image>(Key), 1, 1);
	KeyR41 = erstelle_Objekt_fest_ptr(58, 437, -1000, -200, 100, WandR2L1, std::make_shared<Gosu::Image>(Key), 1, 1);
